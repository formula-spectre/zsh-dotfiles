...
PATH=$PATH:~/.cargo/bin
PATH=$PATH:~/.local/bin
PATH=$PATH:~/.local/bin/dmenu
PATH=$PATH:~/.local/share/junest/bin
PATH=$PATH:~/.junest/usr/bin_wrappers
PATH=$PATH:~/.npm/node_modules
...
if [ -e /home/gentoo-cloud/.nix-profile/etc/profile.d/nix.sh ]; then . /home/gentoo-cloud/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
